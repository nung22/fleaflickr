      ...
      <div class="login-reg reg">
        <form:form action="/register" method="post" modelAttribute="newUser">
          ...
          <div class="form-group row mb-3">
            <form:label class="text-light mb-1" path="firstName"
          ...
          <div class="form-group row mb-3">
            <form:label class="text-light mb-1" path="lastName"
          ...
          <div class="form-group row mb-3">
            <form:label class="text-light mb-1" path="email"
              >Email</form:label
            >
            <form:input
              class="form-control bg-light"
          ...
          <div class="form-group row mb-3">
            <form:label class="text-light mb-1" path="password"
              >Password</form:label
            >
            <form:input
              class="form-control bg-light"
          ...
          <div class="form-group row mb-3">
            <form:label class="text-light mb-1" path="confirm"
          ...
          <input
            class="form-control btn btn-primary fw-bold mt-2"
            type="submit"
