...
<head>
  ...
  <title>FleaFlickr | Project Hub</title>
</head>
<body>
  ...
  <div class="container">
    ...
    <c:choose>
    <c:when test="${projectsNotOnTeam.size() > 0}">
            ...
            <c:forEach var="oneProject" items="${projectsNotOnTeam}">
              <tr style="line-height: 2.7rem;" class="align-middle">
                <td class="px-5">
                  ...
                  onclick="this.classList.remove('text-decoration-underline')"
                ...
                <td>
                  ...
                  href="/join/${user.id}/${oneProject.id}"
                  onmouseover="this.classList.add('bg-success')"
                  onclick="this.classList.remove('bg-success')"
                  onmouseout="this.classList.remove('bg-success')">
                    <img src="/assets/icons/join.png" width="24" alt="gear">
                  </a>
                </td>
              </tr>
            </c:forEach>
    ...
    <c:otherwise>
      <div class="text-center h4 text-secondary pt-5">
        <p>It appears no other users have posted any projects.</p>
        <p>Looks like the only thing to do is
